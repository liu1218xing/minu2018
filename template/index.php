...
<body>
    ...
    <div class="container g-bd-ser-newpro">
      <div class="row">
        ...
        <ul class="list-unstyled m-cloth-class-det visible-lg" id="cloth-sort"> 
        ...
        <div class="block">
          <header>
            ...
            <!-- <div class="row hot-pro-list"> -->
              ...
              // var_dump($proImg);
              ?>
              <div class="col-xs-6 col-sm-4 col-md-4 hot-pro">
                <div class="hot-pro-pic">
                  <a href="product/<?php echo $cate['id']; ?>/1.html" target="_blank">
                    <img class="fill" src="admin/uploads/<?php echo $cate['pimg'];?>" alt="咪奴服装"></a>
                </div>
                <div class="hot-title">
                  <h2>
    ...
    <!-- 制作流程部分 end-->
    <div class="container ">
      <div class="row product-process-list visible-lg">
    ...
    <!-- 企业介绍 -->
     ...
     <!--客户案例-->
    <div class="container index-anli visible-xs">
        <div class="row why-list">
            <div class="col-xs-12 why-sol">
                <h2 class="text-h2">部分客户案例</h2>
            </div>
        </div>
        <div class="row anli-detail">
           <div class="col-sm-4 col-xs-4">
                <img class="fill avatar" src="/images/anlie1.jpg"></a>
              </div>
          <div class="col-sm-4 col-xs-4">
                <img class="fill avatar" src="/images/anlie11.jpg"></a>
              </div>
              <div class="col-sm-4 col-xs-4">
                <img class="fill avatar" src="/images/anlie19.jpg"></a>
              </div>

              <div class="col-sm-4 col-xs-4">
                <img class="fill avatar" src="/images/anlie10.jpg"></a>
              </div>
              <div class="col-sm-4 col-xs-4">
                <img class="fill avatar" src="/images/anlie4.jpg"></a>
              </div>
              <div class="col-sm-4 col-xs-4">
                <img class="fill avatar" src="/images/anlie15.jpg"></a>
              </div>
    ...
    <div class="container">
        <div class="row newlist ">
            <div class="col-sm-4 col-md-3 col-xs-12  hidden-xs">
            ...
            <div class="col-sm-4 col-md-3  col-xs-12 new-list-deta">
                <div class="new-list-tit">
                    <h3>服装知识</h3>
