...
$sql="select id,iId,atitle,akey,adescription,asummary,aName,aSource,aAuthor,aDesc,aHit,createTime,isShow,aImg from mind_case order by id asc limit {$offset},{$pageSize}";
$arows=fetchAll($sql);
// var_dump($arows);
 ?>
<!DOCTYPE html>
...
<body>
    ...
    <!-- nav end -->
    <div class="minupro homepage-panel minu-case" id="minupro">
            ...
            <!-- <div class="row hot-pro-list"> -->
              ...
              <div class="row">
                <div class="col-sm-3 m-news-pic">
                  <a href="/caseDetails/<?php echo $arow['id']; ?>.html" target="_blank">
                    <img class="fill avatar" src="/admin/uploads/<?php echo $arow['aImg'];?>"></a>
                </div>
                  <div class="col-sm-9 m-news-tit">
                  
                    <a href="/caseDetails/<?php echo $arow['id']; ?>.html" target="_blank"><h3><?php echo $arow['aName']; ?></h3></a>
...
<noscript><a href="http://www.51.la/?18985049" target="_blank"><img alt="&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;" src="http://img.users.51.la/18985049.asp" style="border:none" /></a></noscript>
			...
			? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1260742015'%3E%3C/span%3E%3Cscript src='" 
