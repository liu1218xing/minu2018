...
$sql="select p.id,p.pName,p.pSn,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName,p.cId,aImg from product as p join mind_cate c on p.cId=c.id where p.cId={$cid} order by id asc limit {$offset},{$pageSize}";
$pros=fetchAll($sql);
// $id=$_REQUEST['id'];
...
<body>
    ...
    <!-- nav end -->
    <!-- banner 图片 -->
    <div class="minupro homepage-panel minu-product" id="minupro">
