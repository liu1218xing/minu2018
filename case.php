...
$industrys=getAllmIndustry();
$leftParentCates=getAllParentCate();
// $leftParentCates=getAllParentCate();
// var_dump($leftParentCates);
$page=$_REQUEST['page']?(int)$_REQUEST['page']:1;
$id=$_REQUEST['id'];
$mrow = getmIndustryById($id);
// var_dump($mrow);
$sql="select id,atitle,akey,adescription,asummary,aName,aSource,aAuthor,aDesc,aHit,createTime,isShow from mind_case where iId={$id}";
...
$sql="select id,iId,atitle,akey,adescription,asummary,aName,aSource,aAuthor,aDesc,aHit,createTime,isShow,aImg from mind_case where iId={$id} order by id asc limit {$offset},{$pageSize}";
$arows=fetchAll($sql);
// var_dump($arows);
 ?>
<!DOCTYPE html>
        ...
        <div class="col-sm-3 hidden-xs index-left g-sd-ser" id="index-left">
          ...
          <ul class="list-unstyled g-bd-news-tit">
            ...
            <li> <i class="icon-cross-left glyphicon glyphicon-plus"></i>
              <a href="case.php?id=<?php echo $industry['id']; ?>&page=1" target="_blank" alt="<?php echo $industry['iName'];?>
                ">
                <?php echo $industry['iName']; ?></a>
            </li>
            <?php endforeach ?></ul>
            <div class="m-ser-tel onlineservice">
              <h3>在线客户中心</h3>
          ...
          <li>
            ...
            <div class="">
              <ul class="cloth-list list-unstyled">
                ...
                <li> <i class="icon-cross-left glyphicon glyphicon-plus"></i>
                  <a href="product.php?id=<?php echo $leftCate['id']; ?>&page=1" target="_blank"><?php echo $leftCate['cName']; ?></a>
                </li>
              <?php endforeach ?>
              </ul>
            </div>
            ...
            <!-- <div class="row hot-pro-list"> -->
              ...
              <div class="row">
                <div class="col-sm-3 m-news-pic">
                  <a href="caseDetails.php?id=<?php echo $arow['id']; ?>" target="_blank">
                    <img class="fill avatar" src="admin/uploads/<?php echo $arow['aImg'];?>"></a>
                </div>
                  <div class="col-sm-9 m-news-tit">
                  
                    <a href="caseDetails.php?id=<?php echo $arow['id']; ?>" target="_blank"><h3><?php echo $arow['aName']; ?></h3></a>
