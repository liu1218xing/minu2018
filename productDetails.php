...
<head>
    ...
    <meta name="description" content="<?php echo $proinfo['pdescription']; ?>">
    <meta name="keywords" content="<?php echo $proinfo['pkey']; ?>">
    <link href="/publicimg/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <title><?php echo $proinfo['ptitle']; ?></title>
        ...
        <div class="block">
          <header>
            <div class="hot-pro-title">
                <h2 class="text-h2"><?php echo $proinfo['pName']; ?></h2>
                <!-- <hr> -->
            </div>
