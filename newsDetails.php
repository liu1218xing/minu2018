...
editmArticleHit($id);
//var_dump($proinfo);
$description_def ="工作服定做,广州工作服定做,定做工作服,广州工作服厂,咪奴服装,广东咪奴服装有限公司";
$keywords_def ="咪奴是世界500强首选工作服供应商.广州工作服定做哪家好？咪奴服装是广州工作服厂家质量第一品牌.厂家价格.2016年最新款工作服大全.上门免费服务.工作服定做供应厂家.工作服定做哪里找.定做工作服哪里最好.";
$title_def ="广州工作服定做,广州定做工作服厂家,广州工作服厂,定做工作服,咪奴服装,广东咪奴服装有限公司";
$description_new=$proinfo['adescription']?$proinfo['adescription']:$description_def;
$key_new=$proinfo['akey']?$proinfo['akey']:$keywords_def;
$title_new=$proinfo['atitle']?$proinfo['atitle']:$title_def;
// var_dump($description_new);
// var_dump($key_new);
// var_dump($title_new);
...
<head>
    ...
    <meta name="description" content= <?php echo $description_new; ?>>
    <meta name="keywords" content=<?php echo $key_new; ?>;>
        ...
        <div class="block">
          <header>
            <div class="hot-pro-title">
                <h2 class="text-h2"><?php echo $proinfo['aName']; ?></h2>
                <!-- <hr> -->
            </div>
