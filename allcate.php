...
// print_r($_REQUEST);
// $sql="select p.id,p.pName,p.pSn,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName,p.cId from product as p join mind_cate c on p.cId=c.id where p.cId={$cid} order by p.sortid desc,p.pubtime desc";
$sql="SELECT `id` ,`sortid`,`parentid` , `pimg` ,`isshow` ,`cName` ,`createTime` ,`isLeftShow`    FROM  `mind_cate` ORDER BY `isshow` DESC , `sortid` desc,`createTime` DESC ;
";
...
$sql="SELECT `id` ,`sortid`,`parentid` , `pimg` ,`isshow` ,`cName` ,`createTime` ,`isLeftShow`    FROM  `mind_cate` ORDER BY `isshow` DESC , `sortid` desc,`createTime` DESC limit {$offset},{$pageSize}";
$cates=fetchAll($sql);
// var_dump($_SERVER);
// $id=$_REQUEST['id'];
        ...
        <div class="block">
          <header>
            ...
            <div class="row hot-pro-list">
              ...
              <div class="col-xs-6 col-sm-4 hot-pro">
                <div class="hot-pro-pic">
                  <a href="/product/<?php echo $cate['id']; ?>/1.html" target="_blank">
                    <img class="fill avatar img-responsive center-block" src="/admin/uploads/<?php echo $cate['pimg'];?>" alt="咪奴服装"></a>
                </div>
                <div class="hot-title">
                  <h2>
              ...
              <!-- <div class="col-sm-4 col-xs-6 hot-pro">
                <div class="hot-pro-pic">
                  <a href="/productDetails/<?php echo $cate['id'];?>.html" target="_blank">
                    <img height="204" width ="165" class="fill avatar" src="/admin/uploads/<?php echo $cate['pimg'];?>"></a>
                </div>
                <div class="hot-title">
                  <h2>
                    <a href="/productDetails/<?php echo $cate['id'];?>.html" target="_blank"><?php echo $cate['cName']; ?></a>
                  </h2>
                </div>
              </div> -->
              <?php endforeach ?>  
